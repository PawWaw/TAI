...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Model.Food", b =>
                {
                    b.HasOne("Backend.Model.Restaurant", "IdRestaurantNavigation")
                        .WithMany("Foods")
                        .HasForeignKey("IdRestaurant")
                        .HasConstraintName("FK_Food_Restaurant")
                        .IsRequired();

                    b.Navigation("IdRestaurantNavigation");
                });
            ...
            modelBuilder.Entity("Backend.Model.OrderStation", b =>
                {
                    ...
                    b.HasOne("Backend.Model.Restaurant", "Restaurant")
                        .WithOne("OrderStation")
                        .HasForeignKey("Backend.Model.OrderStation", "RestaurantId")
            ...
            modelBuilder.Entity("Backend.Model.Restaurant", b =>
                {
                    b.HasOne("Backend.Model.Owner", "Owner")
                        .WithOne("Restaurant")
                        .HasForeignKey("Backend.Model.Restaurant", "OwnerId")
