...
namespace Backend.Controllers
{
    ...
    public class RestaurantsController : ControllerBase
    {
        ...
        public RestaurantsController(DragorantContext context)
        {
            _context = context;
        }
        ...
        {
            return await _context.Restaurants.Include(e => e.OrderStation).Include(e => e.Owner).ThenInclude(e => e.Restaurant).ThenInclude(e => e.Owner.City).ToListAsync();
        }
